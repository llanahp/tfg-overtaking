...
from t4ac_mapping.map_parser.builder_classes import T4ac_Location
from t4ac_mapping.map_parser.waypoint import T4ac_Waypoint
...
def path_to_waypoint_route(path_route, map_object):
    ...
    Args:
        ...
        map_object: (class) MapObject generated from t4ac_mapping
