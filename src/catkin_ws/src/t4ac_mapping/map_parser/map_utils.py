...
# T4AC imports
from .waypoint import T4ac_Waypoint
from .builder_classes import T4ac_Transform, T4ac_Location
...
def get_point_in_line(x,y,z,s,heading):
    """
    Get a T4ac_Location into a line geometry given an 's' distance and initial pose (x, y , z, heading)
    """
...
def get_point_in_arc(x,y,z,s,curvature,heading):
    """
    Get a T4ac_Location into an arc geometry given an 's' distance  and initial pose (x, y , z, heading)
    """
    location = T4ac_Location(x, y, z)
