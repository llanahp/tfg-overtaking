...
def createModel(args, policy, policy_kwargs, env, log_dir, model_dir,save_path):
	if args.model == "PPO":
		if args.pretrained == "no" and args.compPretrained == "no":
...
def main():
	...
	model = createModel(args, policy, policy_kwargs, env, log_dir, model_dir, save_path)
